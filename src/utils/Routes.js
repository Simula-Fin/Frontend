...
import MyInvestmentsPage from '../pages/myInvestments/myInvestmentsPage';
          ...
          element={
            <MainLayout>
              <Routes>
                ...
                <Route path="/loan-opportunities" element={<Private Item={LoanOpportunitiesPage} />} />
                <Route path="/my-loans" element={<Private Item={MyLoansPages} />} />
                <Route path="/my-investments" element={<Private Item={MyInvestmentsPage} />} />
