        ...
        <nav>
          ...
          <div>
            <button
              ...
              className="block px-4 py-2 hover:bg-gray-700 w-full text-left flex items-center justify-between"
            >
            ...
            {loanOpen && (
              <div className="pl-4">
                ...
                <Link
                  ...
                  className="block px-4 py-2 hover:bg-gray-700 flex items-center"
                >
                  <FaChartLine className="mr-2" /> Oportunidades de
                  Investimentos
                </Link>
              </div>
            )}
          ...
          <div>
            ...
            >
              <span className="flex items-center">
                <FaListUl className="mr-2" /> Simulações
              </span>
