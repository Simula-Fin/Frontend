...
const LoanOpportunities = () => {
  ...
  const confirmInvestment = async () => {
    try {
        ...
        toast.success('Seu investimento foi encaminhado para análise. Você pode verificar o andamento na página de Meus Investimentos.');
        closeModal();
      } catch (error) {
        console.error('Erro ao confirmar o investimento:', error);
        toast.error('Erro ao confirmar o investimento. Por favor, tente novamente.');
      }
  };
